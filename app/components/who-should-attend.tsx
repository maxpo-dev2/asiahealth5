    ...
    <section className="py-6 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="mb-12">
          ...
          <h2 className="text-4xl md:text-8xl font-bold text-[#3EAEC2]">
            Attend?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <div className="relative bg-gradient-to-br from-cyan-200 to-cyan-400 rounded-lg overflow-hidden aspect-[3/4]">
            ...
            <div className="absolute top-4 left-4">
              <div className="text-5xl font-bold text-white/90 stroke-white stroke-2">
                01
              </div>
            </div>
          ...
          <div className="relative bg-gradient-to-br from-cyan-200 to-cyan-400 rounded-lg overflow-hidden aspect-[3/4]">
            <Image
              src="/whoattend/whoattend6.png"
              alt="Elderly Care Providers"
              fill
              className="object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-cyan-500/80 via-transparent to-transparent" />
